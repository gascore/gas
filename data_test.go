...
func TestGet(t *testing.T) {
	data := []struct {
		...
		{
			c:     &C{RC: GetEmptyRenderCore()}, // check will Get throw panic with nil Data map
			query: "hello_world",
			isNil: true,
		},
	}
...
// 					"color": func() string {
// 						if this.Get("bye_world").(string) == "no" {
// 							return "hello"
// 						}
// 						return "bye"
// 					},
...
// 		},
// 		{
// 			c:     &C{}, // check will Get throw panic with nil Data map
// 			query: "hello_world",
// 			value: "...",
...
//
// 	for _, el := range data {
// 		err := el.c.realSet(el.query, el.value)
...
// 		},
// 		func(this *Component) []interface{} {
// 			return []interface{}{len(this.Get("arr").([]interface{}))}
// 		})
// 	c1.RC = GetEmptyRenderCore()
//
// 	data := []struct {
...
// 		}
//
// 		if el.err == nil && len(el.c.Get(el.query).([]interface{})) != el.len {
// 			t.Errorf("invalid array length, want: %d, got: %d", el.len, len(el.c.Get(el.query).([]interface{})))
// 			continue
// 		}
// 	}
// }
...
// 		},
// 		func(this *Component) []interface{} {
// 			return []interface{}{len(this.Get("arr").(map[string]interface{}))}
// 		})
// 	c1.RC = GetEmptyRenderCore()
//
// 	data := []struct {
...
// 		}
//
// 		if el.err == nil && len(el.c.Get(el.query).(map[string]interface{})) != el.len {
// 			t.Errorf("invalid map length, want: %d, got: %d", el.len, len(el.c.Get(el.query).(map[string]interface{})))
// 			continue
// 		}
// 	}
// }
